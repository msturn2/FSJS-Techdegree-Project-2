 ...
 */
 ...
 function pushToDom(element, key, value) {
...
// 1b. Append the `H1` element to the `body` element - body variable created for you above
 ...
 const h1 = pushToDom('h1', 'id', 'main-heading');
...
// 2c. Append the `DIV` element to the `body` element - body variable created for you above
 ...
 const div = pushToDom('div', 'id', 'boat-container');
...
// 3d. Append the `IMG` element to the `DIV` element you created above
 ...
 const boat = pushToDom('img', 'id', 'boat-img');
 boat.setAttribute('src', 'img/boat.png');
 boat.setAttribute('alt', 'Tugboat');
 div.appendChild(boat);
...
// 4e. Append the `IMG` element to the `body` element
 ...
 const frog = pushToDom('img', 'id', 'mike');
 frog.setAttribute('src', 'img/mike.png');
 frog.setAttribute('alt', 'Mike The Frog');
 frog.setAttribute('class', 'mike');
